namespace KilllTheSpiders
{
    partial class MainMenu
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.richTextBox1.Text = "Здраствуйте! Вам предлагается поиграть в игру \"Убей пауков\". Суть проста, на экра" +
    "не появляются паучки, которых вы должны \"убивать\", щелкнув по ним левой кнопкой " +
    "мыши. Чем больше,тем лучше. Вперед!";
            // 
            // button1
            // 
            ...
            this.button3.Location = new System.Drawing.Point(298, 182);
